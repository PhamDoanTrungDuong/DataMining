...
# Nhóm 1: Khách hàng trung niên, thu nhập trung bình và điểm mua sắm trung bình.
#Nhóm 2: Khách hàng trẻ, thu nhập cao và điểm mua sắm cao.
#Nhóm 3: Khách hàng trung niên, thu nhập cao và điểm mua sắm cao.
#Nhóm 4: Khách hàng trung niên, thu nhập thấp và điểm mua sắm thấp.
#Nhóm 5: Khách hàng trẻ, thu nhập thấp và điểm mua sắm thấp.
...
plt.scatter(X[y_means == 2, 0], X[y_means == 2, 1], s = 100, c = 'cyan', label = 'Nhóm 3')
plt.scatter(X[y_means == 3, 0], X[y_means == 3, 1], s = 100, c = 'magenta', label = 'Nhóm 4')
plt.scatter(X[y_means == 4, 0], X[y_means == 4, 1], s = 100, c = 'orange', label = 'Nhóm 5')

plt.scatter(km5.cluster_centers_[:, 0], km5.cluster_centers_[:, 1], s = 100, c = 'blue', label = 'Centeroid')
